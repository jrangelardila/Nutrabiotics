...
/**
 * Strings for component 'factor_sms', language 'es', version '5.1'.
 *
 * @package     factor_sms
 * @category    string
...
$string['privacy:metadata'] = 'El plugin SMS factor phone no almacena ningún dato personal';
...
$string['settings:shortdescription'] = 'Solicitar a los usuarios introducir un código recibido vía SMS durante su autenticación.';
