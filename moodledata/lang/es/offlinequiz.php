...
$string['couldnotextractpages'] = 'Error al extraer páginas de los archivos cargados';
$string['couldnotextractpdf'] = 'Error al intentar convertir pdf a imágenes sencillas. Por favor, pruebe con un documento más pequeño o contacte con su administrador.';
$string['couldnotextracttiff'] = 'Error al convertir tiff a imágenes sencillas. Por favor, pruebe con un documento más pequeño o contacte con su administrador local.';
$string['couldnotgrab'] = 'No se pudo seleccionar la imagen {$a}';
$string['couldnotinsertjobs'] = 'Error con la base de datos al extraer páginas';
...
$string['createlistfirst'] = 'Añadir antes listado de participantes';
...
$string['furtheroptionsheading'] = 'Más opciones';
...
$string['messageprovider:jobs'] = 'Notificaciones de cuestionario offline';
...
$string['modulename_help'] = 'Este módulo permite al profesor diseñar cuestionarios offline compuestos por preguntas de opción múltiple. Estas preguntas se conservan en el banco de preguntas de Moodle y pueden ser reutilizadas en el mismo curso o en otros. Los cuestionarios offline pueden descargarse como archivos PDF, DOCX o LaTeX. Los estudiantes marcan sus respuestas en formularios en papel. Los formularios en papel son escaneados y las respuestas importadas al sistema.
...
$string['privacy:metadata:offlinequizpagesize'] = 'Configura el número de entradas para la página de resultados';
...
$string['queueamountofpages'] = 'Cantidad de archivos incluidos:';
$string['queuedownload'] = 'Descargar';
$string['queuefilecorrect'] = 'Corregir';
$string['queuefilecorrectionhovertext'] = 'Corrección';
$string['queuefiledownloadhovertext'] = 'Descargar';
$string['queuefileerror'] = 'Mensaje de error:';
$string['queuefilefilename'] = 'Archivo origen:';
$string['queuefilegroupnumber'] = 'Número de grupo:';
$string['queuefileheader'] = 'Páginas en este archivo';
$string['queuefileimportedat'] = 'Archivo importado:';
$string['queuefileimportedby'] = 'Importado por:';
$string['queuefilenotstarted'] = 'La evaluación no ha empezado aún';
$string['queuefilepagenumber'] = 'Número de página:';
$string['queuefileprocessing'] = 'Evaluación en progreso...';
$string['queuefilesactionsheader'] = 'Acciones';
$string['queuefilesdetailsheader'] = 'Detalles';
$string['queuefilesfileheader'] = 'Archivo';
$string['queuefilestatus'] = 'Estado del archivo:';
$string['queuefilestatusheader'] = 'Estado';
$string['queuefilestatusmessage_error'] = 'Corrección necesaria';
$string['queuefilestatusmessage_new'] = 'enviado';
$string['queuefilestatusmessage_processed'] = 'OK';
$string['queuefilestatusmessage_processing'] = 'procesando';
$string['queuefilestatusmessage_submitted'] = 'entregado';
$string['queuefilestudent'] = 'Nombre del estudiante:';
$string['queuefinishedtime'] = 'Evaluación terminada a:';
$string['queueheader'] = 'Archivos subidos';
$string['queuenotfinished'] = 'La evaluación no ha terminado.';
$string['queuenotstarted'] = 'La evaluación no ha comenzado.';
$string['queuestarttime'] = 'La evaluación empezó a:';
$string['queuestatus'] = 'Estado de la cola:';
...
$string['selectquestion'] = 'Seleccione pregunta {$a}';
...
$string['tutorial:feedback:3:1'] = 'Sólo se escanean las cruces de las casillas. Por eso es tan importante marcar las casillas correctas bajo tu número de identificación.';
$string['tutorial:feedback:3:2'] = 'Sólo se escanean las cruces de las casillas. Por eso es tan importante marcar las casillas correctas bajo tu número de identificación.';
$string['tutorial:feedback:3:3'] = 'Sólo se escanean las cruces de las casillas. Por eso es tan importante marcar las casillas correctas bajo tu número de identificación.';
$string['tutorial:feedback:3:4'] = 'Sólo se escanean las cruces de las casillas. Por eso es tan importante marcar las casillas correctas bajo tu número de identificación.';
$string['tutorial:feedback:4:0'] = 'Has cometido un error. Tu número de matrícula es {$a->correctusernumber}, pero ha marcado {$a->selectedusernumber}.';
...
$string['tutorial:generatedusernumberwarning'] = 'Este es un número de identificación ficticio para esta simulación, ya que tu perfil no tiene ninguno. Consulta con tu profesor.';
...
$string['tutorial:identification_info'] = 'Tu número de identificación es: {$a}';
...
$string['tutorial:introduction:3:1'] = 'La hoja de respuestas contiene un bloque para tu nombre (A), un bloque para tu número de identificación (B) y un bloque para las respuestas (C). Rellena primero las casillas correspondientes a tu nombre, firma y número de identificación. Ten en cuenta que la máquina no intentará interpretar tu letra después del examen. Estas casillas son sólo a efectos de documentación.';
$string['tutorial:introduction:3:2'] = 'Marca cuidadosamente las casillas correspondientes a tu número de identificación, ya que el ordenador necesitará estas marcas para identificar tus resultados. Los errores en la casilla con tu número de matrícula pueden provocar retrasos e interpretaciones erróneas.';
$string['tutorial:introduction:4'] = 'Al final de este tutorial te ofrecemos una pequeña prueba para que aprendas a rellenar correctamente las casillas de tu número de identificación. Debajo de la casilla de tu número de identificación hay una matriz de casillas. Cada columna representa un dígito de tu número de identificación. Las filas marcan los números escritos a la izquierda y a la derecha. Haz clic en las casillas para marcarlas. Vuelve a hacer clic para borrar la marca. Si quieres empezar de nuevo, por favor <a href="javascript: document.location.reload()">recarga la página</a>.';
...
$string['tutorial:option:3:3'] = 'Sólo se interpretan las cruces de las casillas situadas bajo tu número de identificación.';
$string['tutorial:option:3:4'] = 'El sistema lee tu número de identificación mediante un programa de reconocimiento óptico de caracteres.';
...
$string['tutorial:start_text'] = 'Este tutorial pretende mostrarte la forma correcta de rellenar las hojas de un cuestionario offline y marcar tus respuestas para evaluación automática. Te recomendamos encarecidamente que consultes el tutorial por lo menos una vez, antes de realizar tu primera prueba con un cuestionario offline.';
$string['tutorial:starttutorial'] = 'Comenzar tutorial';
...
$string['unknownmimetype'] = 'Mimetype {$a->mimetpye} desconocido o sin soporte';
...
$string['upgradingilogs'] = 'Resetear datos de cuestionarios offline';
$string['upgradingofflinequizattempts'] = 'Subiendo intentos de cuestionario offline: {$a->done}/{$a->outof} <br/>(Offline quiz ID {$a->info})';
$string['upload'] = 'Subir';
$string['uploadfurtherfiles'] = 'Cargar más archivos';
...
$string['usetabs'] = 'Usar navegación basda en tabuladores';
$string['usetabsdesc'] = 'Si se activa, la navegación de cuestionario offline de tercer nivel se mostrará usando tabuladores. Si se desactiva, se mostrará mediante un menú desplegable.';
$string['valuezero'] = 'El valor no debe ser cero';
$string['viewresults'] = 'Ver resultados';
$string['white'] = 'Blanco';
$string['wirismathenabled'] = 'Permitir ecuaciones WIRIS Math';
$string['wirismathenabled_help'] = 'Si se activa, se pueden usar ecuaciones WIRIS Math en el texto de las preguntas y respuestas.';
