...
/**
 * Strings for component 'glossary', language 'es', version '5.1'.
 *
 * @package     glossary
 * @category    string
...
$string['numberofentriesneedapprove'] = 'Necesita aprobación';
...
$string['seeallentries'] = 'Ver todas las entradas';
