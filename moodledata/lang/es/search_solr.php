...
/**
 * Strings for component 'search_solr', language 'es', version '5.1'.
 *
 * @package     search_solr
 * @category    string
...
$string['check_indextoobig'] = 'Índice mayor al tamaño especificado';
$string['check_nocore'] = 'No se pudo encontrar índice en servidor Solr';
$string['check_nosize'] = 'No se pudo determinar el tamaño del índice en servidor Solr';
$string['check_notconnected'] = 'No se pudo conecta a servidor Solr';
$string['check_time'] = 'El servidor ha respondido con estado en {$a}';
...
$string['indexsize'] = 'El índice está usando {$a} en el servidor {$a}.';
$string['indexsizelimit'] = 'Límite de tamaño del índice';
$string['indexsizelimit_desc'] = 'Muestra un error en la página de informe de estado si el índice es mayor que su tamaño (en bytes), y un aviso si excede 90%. Cero significa sin límite de tamaño de indexación.';
