...
/**
 * Strings for component 'reportbuilder', language 'es', version '5.1'.
 *
...
$string['duplicateaudiences'] = 'Duplicar audiencias';
$string['duplicatereport'] = 'Duplicar informe';
$string['duplicateschedules'] = 'Duplicar planificaciones';
...
$string['errorreportduplicate'] = 'Usted no puede duplicar este informe';
...
$string['privacy:metadata:user_filter'] = 'Reportar definiciones de filtros de usuario';
$string['privacy:metadata:user_filter:filterdata'] = 'Datos de configuración de los filtros de informes';
$string['privacy:metadata:user_filter:timecreated'] = 'La hora de creación del filtro de usuario';
$string['privacy:metadata:user_filter:timemodified'] = 'La hora de última modificación del filtro de usuario';
$string['recurrence'] = 'Recurrencia';
$string['recurrenceannually'] = 'Anualmente';
$string['recurrencedaily'] = 'Diario';
$string['recurrencehourly'] = 'A la hora';
...
$string['reportbuildercustomfields'] = 'Campos de informe personalizado';
...
$string['timenextsend'] = 'Hora de próximo envío';
