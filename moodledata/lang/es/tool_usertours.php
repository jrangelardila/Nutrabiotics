...
/**
 * Strings for component 'tool_usertours', language 'es', version '5.1'.
 *
...
$string['filter_category_help'] = 'Mostrar este tour en páginas asociadas a cursos de la categoría seleccionada.';
$string['filter_course'] = 'Cursos seleccionados';
$string['filter_course_error_course_selection'] = 'Debe seleccionar un curso como mínimo';
$string['filter_course_help'] = 'Según el valor del filtro de cursos:

* **Sólo cursos seleccionados**: Mostsrar este tour en páginas asociadas a los cursos seleccionados.
* **Todos los cursos menos los seleccionados**: No mostrar este tour en páginas asociadas a los cursos seleccionados.';
$string['filter_course_operator'] = 'Cursos';
$string['filter_course_operator_all'] = 'Todos los cursos';
$string['filter_course_operator_except'] = 'Todos los cursos salvo los seleccionados';
$string['filter_course_operator_help'] = 'Se puede configurar el tour para que aparezca sólo en ciertos cursos.

* **Todos los cursos**: Mostrar el tour sea cual sea el curso.
* **Sólo cursos seleccionados**: Mostsrar este tour en páginas asociadas a los cursos seleccionados abajo.
* **Todos los cursos menos los seleccionados**: No mostrar este tour en páginas asociadas a los cursos seleccionados abajo.';
$string['filter_course_operator_select'] = 'Sólo cursos seleccionados';
...
$string['filter_exclude_category'] = 'Excluir categorías';
$string['filter_exclude_category_help'] = 'No mostrar este tour en páginas asociadas a las categorías de curso seleccionadas.

Si selecciona una categoría superior, se seleccionarán todas sus subcategorías y no podrán seleccionarse individualmente.

Elimine la selección de la categoría superior para seleccionar las subcategorías de nuevo.';
