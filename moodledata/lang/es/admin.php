...
$string['composerdeveloperdependenciesinstalled'] = 'Las dependencias Composer Developer están instaladas. Por favor, asegúrese de que el comando "composer install --no-dev --classmap-authoritative" se haya ejecutado en el directorio root de Moodle';
$string['composernotfound'] = 'No se han encontrado dependencias Composer. Por favor, asegúrse de que el comando "composer install --no-dev --classmap-authoritative" se haya ejecutado en el directorio root de Moodle. Si usted no está usando Composesr, asegúrese de que el directorio exista y contenga los archivos necesarios.';
$string['composernotoptimised'] = 'Moodle está ejecutándose en modo producción mientras que el autocargador Composer no está optimizado. Tal vez usted desee ejecutar "composer install --no-dev --classmap-authoritative" para optimizar el autocargador.';
$string['composeroptimisedindevmode'] = 'El autocargador Composer está ejecutándose actualmente optimizado mientras Moodle está en modo desarrollador. Esto puede causar problemas en algunos casos. Tal vez usted desee ejecutar "composer install" sin argumentos adicionales.';
