...
/**
 * Strings for component 'tiny_h5p', language 'es', version '5.1'.
 *
 * @package     tiny_h5p
 * @category    string
...
$string['h5p:use'] = 'Usar H5P de TinyMCE';
...
$string['mobileappautoplay'] = 'Reproducir automáticamente en la app móvil';
