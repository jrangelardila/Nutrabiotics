...
/**
 * Strings for component 'backup', language 'es', version '5.1'.
 *
 * @package     backup
 * @category    string
...
$string['qcategory2coursefallback'] = 'La categoría de preguntas "{$a->name}", originalmente en el contexto de sistema/curso/categoría en la copia de seguridad, se creará en un contexto de módulo de banco de preguntas al ser restaurada.';
$string['qcategorycannotberestored'] = 'La categoría de preguntas "{$a-> name}" no puede ser creada por restauración';
$string['question2coursefallback'] = 'La categoría de preguntas "{$a->name}", originalmente en sistema/curso/categoría en la copia de seguridad, se creará en un módulo de banco de preguntas al ser restaurada.';
