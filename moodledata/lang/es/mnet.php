...
/**
 * Strings for component 'mnet', language 'es', version '5.1'.
 *
 * @package     mnet
 * @category    string
...
$string['privacy:metadata:mnet_external:alternatename'] = 'Un nombre alernativo para el usuario.';
$string['privacy:metadata:mnet_external:autosubscribe'] = 'Una preferencia sobre si el usuario debería auto-suscribirse a los foros donde publica.';
$string['privacy:metadata:mnet_external:calendartype'] = 'Una preferencia de usuario para el tipo de calendario a usar.';
$string['privacy:metadata:mnet_external:city'] = 'La ciudad del usuario.';
$string['privacy:metadata:mnet_external:country'] = 'El país en que está el usuario.';
$string['privacy:metadata:mnet_external:currentlogin'] = 'El acceso actual de este usuario.';
$string['privacy:metadata:mnet_external:department'] = 'El departamento donde este usuario puede encontrarse.';
$string['privacy:metadata:mnet_external:description'] = 'Datos generales sobre este usuario.';
$string['privacy:metadata:mnet_external:email'] = 'La dirección de correo elecrónico de contacto.';
$string['privacy:metadata:mnet_external:emailstop'] = 'Una preferencia para para correos enviados a este usuario.';
$string['privacy:metadata:mnet_external:firstaccess'] = 'El momento en que este usuario accedió or primera vez al sitio.';
...
$string['privacy:metadata:mnet_external:id'] = 'El ID del usuario.';
$string['privacy:metadata:mnet_external:idnumber'] = 'Un número identificativo dado por la institución';
$string['privacy:metadata:mnet_external:imagealt'] = 'Texto alternativo para la imagen del usuario.';
$string['privacy:metadata:mnet_external:institution'] = 'La institución de la que es miembro este usuario.';
$string['privacy:metadata:mnet_external:lang'] = 'Una preferencia de usuario sobre la lengua a mostrar.';
$string['privacy:metadata:mnet_external:lastaccess'] = 'El momento en que el usuario accedió al sitio por última vez.';
$string['privacy:metadata:mnet_external:lastlogin'] = 'El último acceso de este usuario.';
...
$string['privacy:metadata:mnet_external:maildigest'] = 'Un ajuste para el resumen de correo de este usuario.';
$string['privacy:metadata:mnet_external:maildisplay'] = 'Una preferencia del usuario sobre mostrar su correo electrónico a otros usuarios.';
$string['privacy:metadata:mnet_external:middlename'] = 'El segundo nombre del usuario';
$string['privacy:metadata:mnet_external:phone1'] = 'Un número de teléfono del usuario.';
$string['privacy:metadata:mnet_external:phone2'] = 'Un número de teléfono adicional del usuario.';
$string['privacy:metadata:mnet_external:picture'] = 'Los detalles de la imagen asociada a ese usuario.';
$string['privacy:metadata:mnet_external:policyagreed'] = 'Una marca para determinar si el usuario ha aceptado la política del sitio.';
$string['privacy:metadata:mnet_external:suspended'] = 'Una marca para mostrar si el usuario ha sido suspendido en este sistema.';
$string['privacy:metadata:mnet_external:timezone'] = 'La zona horaria del usuario';
$string['privacy:metadata:mnet_external:trackforums'] = 'Una preferencia sobre foros y su seguimiento.';
$string['privacy:metadata:mnet_external:trustbitmask'] = 'La máscara de bit de confianza';
$string['privacy:metadata:mnet_external:username'] = 'El nombre de usuario de este usuario.';
$string['privacy:metadata:mnet_log'] = 'Detalles de acciones remotas realizadas por un usuario local conectado en sistema remoto.';
...
$string['privacy:metadata:mnet_log:course'] = 'ID de curso de sistema remoto donde se realizó la acción.';
$string['privacy:metadata:mnet_log:coursename'] = 'Nombre completo del curso del sistema remoto donde se realizó la acción.';
$string['privacy:metadata:mnet_log:hostid'] = 'ID MNet de sistema remoto.';
$string['privacy:metadata:mnet_log:info'] = 'Información adicional sobre la acción.';
$string['privacy:metadata:mnet_log:ip'] = 'La dirección IP usada en el momento en que sucedió la acción.';
$string['privacy:metadata:mnet_log:module'] = 'Módulo de sistema remoto donde suedió la acción.';
$string['privacy:metadata:mnet_log:remoteid'] = 'ID remoto del usuario que realizó la acción en el sistema remoto.';
$string['privacy:metadata:mnet_log:time'] = 'Momento en que ocurrió la acción.';
$string['privacy:metadata:mnet_log:url'] = 'URL de sistema remoto donde ocurrió la acción.';
$string['privacy:metadata:mnet_log:userid'] = 'ID local del usuario que realizó la acción en el sistema remoto.';
$string['privacy:metadata:mnet_session'] = 'Los detalles de cada sesión de usuario MNet en un sistema remoto. Los datos se guardan temporalmente.';
$string['privacy:metadata:mnet_session:expires'] = 'El momento en que expira la sesión.';
$string['privacy:metadata:mnet_session:mnethostid'] = 'ID MNet de sistema remoto.';
$string['privacy:metadata:mnet_session:token'] = 'Idenitificador único de la sesión.';
$string['privacy:metadata:mnet_session:useragent'] = 'Agente de usuario usado para acceder al sistema remoto';
$string['privacy:metadata:mnet_session:userid'] = 'ID del usuario que salta a sistema remoto.';
$string['privacy:metadata:mnet_session:username'] = 'Nombre del usuario que salta a sistema remoto.';
