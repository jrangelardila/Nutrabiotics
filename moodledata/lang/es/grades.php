...
/**
 * Strings for component 'grades', language 'es', version '5.1'.
 *
 * @package     grades
 * @category    string
...
$string['errornegativepenalty'] = 'Valor negativo recibido durante la agregación de penalización para el ID de calificación {$a}.';
...
$string['gradepenalty_enabledmodules'] = 'Actividades habiitadas';
$string['gradepenalty_enabledmodules_help'] = 'Habilitar penalizacines para las actividades seleccionadas.';
$string['gradepenalty_indicator_info'] = 'Última penalización aplicada-{$a} puntos';
$string['gradepenalty_supportedplugins'] = 'Gestionar actividades soportadas';
...
$string['managepenaltyplugins'] = 'Gestionar plugins de penalización';
...
$string['modgraderecalculatepenalty'] = 'Recalcular penalización';
$string['modgraderecalculatepenalty_help'] = 'La penalización se recalculará para todos los usuarios.';
...
$string['recalculatepenalty'] = 'Recalcular penalizaciones';
$string['recalculatepenaltyconfirm'] = 'Esto recalculará y aplicará penalizaciones para todas las entregas en este contexto. ¿Seguro que desea continuar?';
$string['recalculatepenaltysuccess'] = 'Recálculo de penalización en progreso. Puede que haya un retardo antes de la actualización de las calificaciones.';
$string['recalculatinggrades'] = 'Recalculando calificaciones';
$string['recalculatinggradesadhoc'] = 'El informe se actualizará automáticamente. No hace falta que haga nada más';
