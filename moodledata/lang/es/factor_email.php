...
/**
 * Strings for component 'factor_email', language 'es', version '5.1'.
 *
...
$string['settings:description'] = 'Los usuarios recibirán por correo electrónico un código de verificación de seis dígitos que deberán introducir para completar el proceso de autenticación.';
$string['settings:duration'] = 'Periodo de validez';
$string['settings:duration_help'] = 'El tiempo durante el cual el código es válido.';
$string['settings:shortdescription'] = 'Requerir a los usuarios que introduzcan un código recibido mediante correo electrónico durante la autenticación.';
