...
/**
 * Strings for component 'auth_db', language 'es', version '5.1'.
 *
 * @package     auth_db
 * @category    string
...
$string['auth_dbsybasequotinghelp'] = 'Escapado de comilla simple al estilo Sybase - necesario para MS SQL y algunas otras bases de datos. ¡No lo utilice para MySQL!';
