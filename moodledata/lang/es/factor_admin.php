...
/**
 * Strings for component 'factor_admin', language 'es', version '5.1'.
 *
...
$string['settings:description'] = 'Todos los usuarios salvo los administradores del sitio reciben los puntos de este factor. Esto le permite solicitar factores de autenticación adicionales para administradores del sitio.';
$string['settings:shortdescription'] = 'Requerir factores de autenticación adicionales para administradores.';
