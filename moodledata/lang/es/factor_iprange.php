...
/**
 * Strings for component 'factor_iprange', language 'es', version '5.1'.
 *
...
$string['settings:description'] = 'Permitir autenticación de usuario mediante dirección IP. Esto no requiere configuración de usuario y puede proporcionar un acceso seguro y sin fisuras en redes de confianza.';
...
$string['settings:shortdescription'] = 'Usar direcciones IP para verificar automáticamente la identidad de los usuarios.';
