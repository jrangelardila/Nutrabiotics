...
/**
 * Strings for component 'cachestore_file', language 'es', version '5.1'.
 *
...
$string['useserializer_help'] = 'El serializador a usar para serializar. El serializador igbinary, si está disponible, puede reducir los requisitos de almacenamiento para cachés grandes. Esto sólo está soportado si está cargada la extensión igbinary.';
