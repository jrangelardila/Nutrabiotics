...
/**
 * Strings for component 'plugin', language 'es', version '5.1'.
 *
 * @package     plugin
 * @category    string
...
$string['deprecated_type'] = 'Tipo de plugin discontinuado';
...
$string['type_gradepenalty'] = 'Penalización';
$string['type_gradepenalty_plural'] = 'Penalizaciones';
