...
$string['allowedattempts'] = 'Intentos permitidos por estudiante';
...
$string['handlingofretakes'] = 'Método de calificación';
$string['handlingofretakes_help'] = 'Cómo se calcula la nota cuando los estudiantes hacen más de un intento:

* Nota máxima de entre todos los intentos
...
$string['maximumnumberofattempts_help'] = 'Cuántas veces puede el estudiante intentar cada pregunta. Si alcanzan el límite sin respuesta correcta, la lección continúa a la siguiente página.';
$string['maximumnumberofattemptsreached'] = 'Ha alcanzado el número máximo de intentos. La lección pasará ahora a la siguiente página.';
...
$string['retakesallowed'] = 'Múltiples intentos permitidos';
$string['retakesallowed_help'] = 'Permite a los estudiantes intentar la lección más de una vez.';
$string['retakesallowedinfo'] = 'Esta lección permite a los estudiantes hacer múltiples intentos.';
$string['returnto'] = '{$a}';
...
$string['studentswhoattempted'] = 'Estudiantes que han hecho intentos';
...
$string['totalattepmts'] = 'Intentos totales';
...
$string['usemaximum'] = 'Nota más alta de todos los intentos';
$string['usemean'] = 'Nota media de todos los intentos';
