...
/**
 * Strings for component 'qtype_ddimageortext', language 'es', version '5.1'.
 *
...
$string['dropzonevisibility'] = 'Visibilidad de zona para soltar';
$string['dropzonevisibility_help'] = '¿Deberían ser transparente las zonas para soltar para que no cubran partes de la imagen de fondo? Los elementos arrastrados se ajustarán a las zonas para soltar más cercanas.';
$string['dropzonevisibility_hideoption'] = 'Zonas para soltar transparentes';
$string['dropzonevisibility_showoption'] = 'Mostrar zonas para soltar';
$string['dropzonevisibilitydesc'] = 'Los bordes seguirán siendo visibles al editar la pregunta para ayudar a configurar la zona para soltar.';
