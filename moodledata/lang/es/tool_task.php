...
/**
 * Strings for component 'tool_task', language 'es', version '5.1'.
 *
 * @package     tool_task
 * @category    string
...
$string['confirmdeletetaskwithid'] = '¿Seguro que quiere borrar la tarea con este ID:  {$a->id}?';
...
$string['deleteadhoctask'] = 'Borrar tareas ad hoc {$a}';
...
$string['runclassnamedueonly'] = 'Ejecutar sólo lo vencido';
