...
$string['allowedattemptsperstudent'] = 'Intentos permitidos por estudiante';
...
$string['averageattemptsperstudent'] = 'Media de intentos por estudiante';
...
$string['precreateattempts_desc'] = 'Crear intentos previamente ayuda a optimizar el rendimiento del sitio. Además de habilitar esta configuración, usted necesita un periodo de creación previa. Nota: esta configuración sólo se aplica a cuestionarios con fecha de apertura.';
...
$string['precreateperiod_desc'] = 'Si su sitio tiene cuestionarios con fecha de apertura y muchos estudiantes empiezan a la vez, puede mejorar el rendimiento creando intentos previamente. Seleccione un periodo de tiempo previo al momento de apertura del cuestionario para crear intentos previamente. Se recomienda que sea corto, ya que las preguntas del cuestionario no podrán modificarse una vez que el cuestionario tenga intentos. Los intentos se generan mediante una tarea programada que se ejecuta cada hora por defecto. Para que los intentos previos se generen cuando el sistema tenga menos carga, como durante la noche, configure un periodo de 12 horas, y ajuste la tarea programada para que se ejecute durante horas de menos carga.';
...
$string['studentswhoattempted'] = 'Estudiantes que lo intentaron';
