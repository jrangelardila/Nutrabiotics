...
$string['assignmentduedigestsms'] = 'Una o más tareas vencen en 7 días. Acceda para ver las próximas entregas.';
...
$string['assignmentduesoonsms'] = 'Su tarea {$a->assignmentname} vence el {$a->duedate}: {$a->shortlink}';
...
$string['assignmentoverduesms'] = 'Su tarea {$a->assignmentname} vence el {$a->duedate}: {$a->shortlink}';
...
$string['feedbackavailableanonsms'] = 'Nueva retroalimentación en "{$a->assignment}\' in \'{$a->coursefullname}". Acceda para verla';
...
$string['feedbackavailablesms'] = 'Nueva retroalimentación en "{$a->assignment}\' in \'{$a->coursefullname}". Acceda para verla';
...
$string['gradepenalty_help'] = 'Si se activa, se aplicarán penalizaciones en las entregas posteriores al vencimiento.';
...
$string['gradersubmissionupdatedsms'] = '{$a->username} ha actualizado su entrega de la tarea "{$a->assignment}" en "{$a->coursefullname}". Acceda para verla';
...
$string['resizelayout'] = 'Redimensionar disposición';
...
$string['submissioncopiedsms'] = 'Ha copiado su entrega anterior para "{$a->assignment}" en "{$a->coursefullname}". Acceda para verlo';
...
$string['submissionreceiptothersms'] = 'Entrega realizada para "{$a->assignment}" en "{$a->coursefullname}". Acceda para ver el estado de su entrega';
...
$string['submissionreceiptsms'] = 'Usted ha entregado "{$a->assignment}" en "{$a->coursefullname}". Acceda para ver el estado de su entrega';
