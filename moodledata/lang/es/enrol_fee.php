...
/**
 * Strings for component 'enrol_fee', language 'es', version '5.1'.
 *
 * @package     enrol_fee
 * @category    string
...
$string['instancedescription'] = 'Descripción de instancia';
$string['instancedescription_help'] = 'La descripción sólo se ve en la página de "Métodos de matriculación" y no se muestra a los usuarios que se matriculan en el curso.';
