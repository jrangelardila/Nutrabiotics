...
/**
 * Strings for component 'factor_grace', language 'es', version '5.1'.
 *
...
$string['settings:description'] = 'Permitir a los usuarios autenticarse sin MFA durante un tiempo específico, dándoles tiempo para configurar sus factores de autenticación. Una vez expire el periodo de gracia, los usuarios deben usar MFA para autenticarse.';
...
$string['settings:shortdescription'] = 'Permitir a los usuarios autenticarse sin MFA durante un periodo específico, dándoles tiempo para configurar sus factores de autenticación.';
