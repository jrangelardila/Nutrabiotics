...
/**
 * Strings for component 'factor_webauthn', language 'es', version '5.1'.
 *
...
$string['registererror'] = 'No se pudo registrar clave de seguridad: {$a}';
$string['registersuccess'] = 'Clave de seguridad registrada.';
...
$string['settings:description'] = '<p>Los usuarios se autentican mediante una llave de seguridad física, como un USB o un token NFC, o un méotodo biométrico como una huella dactilar. Durante el acceso, deben usar físicamente su llave de seguridad para verificar su identidad.</p>
<p>Los usuarios tendrán que haber configurado sus llaves de seguridad previamente.</p>';
$string['settings:shortdescription'] = 'Soliciitar a los usuarios usar una llave de seguridad, como un USB o un token NFC, o un método biométrico, durante el acceso.';
